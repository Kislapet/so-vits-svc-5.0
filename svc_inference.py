...
def main(args):
    ...
    with torch.no_grad():
        ...
        write(os.path.splitext(os.path.basename(args.wave))[0] + "_out_pit.wav", hp.data.sampling_rate, pitwav)
    ...
    write(os.path.splitext(os.path.basename(args.wave))[0] + "_out.wav", hp.data.sampling_rate, out_audio)
